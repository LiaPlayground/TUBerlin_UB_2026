...
%  Workshop "Interaktive OER mit LiaScript", TU Berlin · Universitätsbibliothek 2026
...
\begin{minipage}[c]{0.20\linewidth}\raggedright
  {\sffamily\scriptsize\color{white!85}\faGraduationCap~~Workshop~$\cdot$~TU Berlin~$\cdot$~UB 2026}\\[2pt]
...
\faGithub~Quellcode: \textbf{github.com/LiaPlayground/TUBerlin\_UB\_2026}}
...
\end{minipage}\hfill
\begin{minipage}[c]{0.10\linewidth}\centering
  {\color{black}\colorbox{white}{\hspace{1pt}\qrcode[height=1.55cm,nolinks]{https://github.com/LiaPlayground/TUBerlin_UB_2026}\hspace{1pt}}}\\[1pt]
...
CC-BY-SA 4.0 — Sebastian Zug \& André Dietrich, TU Berlin UB 2026}
